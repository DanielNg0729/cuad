...
**6.** archival backups of such mirrored computer storage on a weekly basis;

2

**7.** off-site storage of such backups at separate facility than the location of the Hosting Computer;

**8.** use of the Microsoft Windows NT Server

**4.0** or higher operating system software for the Hosting Computer and the Hosted Site;

**9.** use of the Microsoft Internet Information Service (IIS)

**3.0** or higher Web server software for the Hosted Site (providing support for the HTTP Web protocol);

**10.** use of the Microsoft SQL Server

**6.5** or higher database server software for the Hosted Site, within the boundaries of allocated computer storage, per #5 above;
...
**10.** mailboxes accessible via the POP3 mail protocol that are mapped to the Hosted Site's Internet address;

**13.** up to

**1.** hour per month of Web site administration services at no additional charge, limited to:
