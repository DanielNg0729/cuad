...
|                                                                      | ---------   | --------   | ---------   |
|----------------------------------------------------------------------|-------------|------------|-------------|
| Manufacturing (May be adjusted if actual costs exceed above amounts) | $ [**]/1/   | $ [**]/1/  | $ [**]/1/   |
...
- 10 subsidiary or otherwise, or to any person, firm or corporation into which or with it might merge or consolidate. In the event of such an
